...
<p>Version 1.4 - 27 March 2026</p>
<pre>
- Added: Continue Reading Across Devices (Cross-platform sync)
- Added: AI-Powered Book Recommendations (“Recommended for You”)
- Added: Follow Author System
- Added: Smart Search (Suggestions, Recent & Trending)
- Added: Referral / Invite System
- Added: Flash Deals & Limited Offers
- Added: Author analytics (books, sales, earnings)
- Added: User purchase tracking
- Added: Most read & top-selling analytics (daily, weekly, monthly, yearly)
- Added: Ratings filter in reviews
- Added: Sales export functionality
- Added: Coupon notes support
- Added: Advanced filtering (username, date range)
- Improved: Search performance & UX & Data filtering & reporting system
</pre>

<p>Version 1.3 – 13 Feb 2026</p>
<pre>
