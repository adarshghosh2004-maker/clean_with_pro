	...
	<div class="body-content">
		...
		<div class="border-bottom row mb-3">
			...
			<div class="col-sm-2 d-flex align-items-center justify-content-end">
				<a href="{{ route('admin.service.index') }}" class="btn btn-default mw-120 mt-14">{{__('label.service_list')}}</a>
			</div>
		</div>
			...
			<div class="card-body">
				<form name="service" id="service_update" enctype="multipart/form-data" autocomplete="off">
                        ...
                        <div class="form-row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="title" class="form-control" placeholder="{{__('label.name_here')}}" value="{{ $data->title }}" autofocus>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>{{__('label.short_title')}}<span class="text-danger">*</span></label>
                                    <input type="text" name="short_title" class="form-control" placeholder="{{__('label.short_title_here')}}" value="{{ $data->short_title }}">
                                </div>
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="col-md-12">
                                <div class="form-group">
                                 ...
                                 <textarea class="form-control" name="description" placeholder="{{ __('label.description_here') }}">{{ $data->description }}</textarea>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="form-group ml-4">
                            ...
                            <div class="avatar-upload ml-5">
                                <div class="avatar-edit">
                                    <input type='file' name="banner_img" id="imageUpload" accept=".png, .jpg, .jpeg, .webp" />
					...
					<div class="border-top pt-3 text-right">
						<button type="button" class="btn btn-default mw-120" onclick="update_service()">{{__('label.update')}}</button>
						<a href="{{route('admin.service.index')}}" class="btn btn-cancel mw-120 ml-2">{{__('label.cancel')}}</a>
