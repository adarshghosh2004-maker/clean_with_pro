...
@section('page_title', __('label.feature'))
@section('tab_title', __('label.feature'))
...
<div class="right-content">
    ...
    <div class="body-content">
        ...
        <div class="border-bottom row mb-3">
            <div class="col-sm-12">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">{{__('label.feature')}}</li>
                </ol>
            </div>
        </div>
        ...
        <div class="card custom-border-card mt-3">
            <h5 class="card-header">{{__('label.add_feature')}}</h5>
            <div class="card-body">
                <form id="feature" enctype="multipart/form-data">
                    ...
                    <div class="border-top pt-3 text-right">
                        <button type="button" class="btn btn-default mw-120" onclick="save_feature()">{{__('label.save')}}</button>
            ...
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel">{{__('label.edit_feature')}}</h5>
                        <button type="button" class="close text-dark" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                    <form id="edit_feature" enctype="multipart/form-data">
                        ...
                        <div class="modal-footer">
                            <button type="button" class="btn btn-default mw-120" onclick="update_feature()">{{__('label.update')}}</button>
...
<script>
        ...
        if (Demo_Mode == 1) {
            ...
            $.ajax({
                ...
                success: function(resp) {
                    $("#dvloader").hide();
                    get_responce_message(resp, 'feature', '{{ route("admin.feature.index") }}');
                },
    ...
    function update_feature() {
        ...
        if (Demo_Mode == 1) {
            ...
            $("#dvloader").show();
            var formData = new FormData($("#edit_feature")[0]);

            var Edit_Id = $("#edit_id").val();
            var url = '{{ route("admin.feature.update", ":id") }}';
            ...
            $.ajax({
                ...
                success: function(resp) {
                    ...
                    get_responce_message(resp, 'edit_feature', '{{ route("admin.feature.index") }}');
                },
                error: function(XMLHttpRequest, textStatus, errorThrown) {
                    $("#dvloader").hide();
                    toastr.error(errorThrown, textStatus);
    ...
    function change_status(id) {
        ...
        if (Demo_Mode == 1) {
            ...
            $("#dvloader").show();
            var url = `{{ route('admin.feature.show', '') }}/${id}`;
