        ...
        <div class="row justify-content-center">
            <div class="col-lg-8" data-anim="fade-up">
                <div class="text-center mb-5">
                    <h2 class="section-title">{{ __('label.know_more_about') }} <span>Clean With Professionals</span></h2>
                    <p class="text-muted">{{ __('label.frequently_asked_questions') }}</p>
                </div>
                ...
                <div class="accordion" id="faqAccordion">
                    <div class="accordion-item">
                        ...
                        <div id="faq1" class="accordion-collapse collapse show" data-bs-parent="#faqAccordion">
                            <div class="accordion-body text-muted">
                                Absolutely. Every team member comes fully equipped with industrial-grade tools and
                                eco-friendly
                    ...
                    <div class="accordion-item">
                        ...
                        <div id="faq3" class="accordion-collapse collapse" data-bs-parent="#faqAccordion">
                            <div class="accordion-body text-muted">
                                Yes, we prioritize health and safety. We use eco-friendly, non-toxic products that are
                                entirely safe
                    ...
                    <div class="accordion-item">
                        ...
                        <div id="faq4" class="accordion-collapse collapse" data-bs-parent="#faqAccordion">
                            <div class="accordion-body text-muted">
                                No, it is not necessary. Many of our clients provide us with a key or access code. All
                                our staff are
