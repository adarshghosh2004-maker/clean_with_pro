...
@section('content')
  ...
  <section class="py-5 my-5 container-custom px-4 text-center" data-aos="fade-up">
  ...
  <section class="section-padding services-showcase" data-aos="fade-up">
    <div class="container">
        ...
        <div class="col-lg-5" data-aos="fade-right">
          <div class="nav flex-column nav-pills nav-pills-custom" id="v-pills-tab" role="tablist"
            ...
            <button class="nav-link active" id="v-pills-commercial-tab" data-bs-toggle="pill"
              data-bs-target="#v-pills-commercial" type="button" role="tab" data-aos="fade-up"
              data-aos-delay="100">Commercial Cleaning</button>
            <button class="nav-link" id="v-pills-toilet-tab" data-bs-toggle="pill" data-bs-target="#v-pills-toilet"
              type="button" role="tab" data-aos="fade-up" data-aos-delay="150">Daily Basic Toilet Wash</button>
            <button class="nav-link" id="v-pills-post-tab" data-bs-toggle="pill" data-bs-target="#v-pills-post"
              type="button" role="tab" data-aos="fade-up" data-aos-delay="200">Post Construction Cleaning</button>
            <button class="nav-link" id="v-pills-window-tab" data-bs-toggle="pill" data-bs-target="#v-pills-window"
              type="button" role="tab" data-aos="fade-up" data-aos-delay="250">Window & Facade Cleaning</button>
          </div>
        </div>
