                        ...
                        <td style="padding: 30px; color: #000000;">
                            <div style="font-size: 18px; line-height: 1.7; color: #000000;">
                                <p style="margin-bottom: 20px;">
                                    ...
                                    Thank you for your purchase on <strong>{{ App_Name(); }}</strong>! 🎉<br><br>
                                    Here are the details of your transaction:
                                </p>

                                <ul style="font-size: 16px; padding-left: 20px;">
                                    <li><strong>Content:</strong> {{ $details['content_title'] ?? '-' }}</li>
                                    <li><strong>Price:</strong> {{ $details['price'] ?? '-' }}</li>
                                    <li><strong>Transaction ID:</strong> {{ $details['transaction_id'] ?? '-' }}</li>
                                    <li><strong>Date:</strong> {{ $details['date'] ?? date('d M Y') }}</li>
                                </ul>

                                <p>You can now access your content anytime from your <strong>Library</strong> section.</p>

                                <p style="margin-top: 30px;">Enjoy your content!<br><strong>{{ App_Name(); }}</strong> Team</p>
                            </div>
                        </td>
                    </tr>
