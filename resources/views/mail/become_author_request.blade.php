                        ...
                        <td style="padding: 30px; color: #000000;">
                            <div style="font-size: 18px; line-height: 1.7;">
                                <p style="margin-bottom: 20px;">
                                    Thank you for your interest in becoming an author on <strong>{{ App_Name(); }}</strong>! ✍️<br><br>
                                    We’ve received your author request and our team will review it shortly. You’ll be notified once your request has been processed.
                                </p>
