                        ...
                        <td style="padding: 30px; color: #000000;">
                            <div style="font-size: 18px; line-height: 1.7; color: #000000;">
                                <p style="margin-bottom: 20px;">
                                    ...
                                    Your request to become an author on <strong>{{ App_Name(); }}</strong> has been <strong style="color: green;">Approved</strong>. You now have access to all the tools and features needed to publish your content.
                                </p>

                                <p>We’re excited to have you onboard and look forward to your amazing contributions!</p>
