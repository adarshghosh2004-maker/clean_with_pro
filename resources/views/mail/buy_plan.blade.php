                        ...
                        <td style="padding: 30px; color: #000000;">
                            <div style="font-size: 18px; line-height: 1.7; color: #000000;">
                                ...
                                <ul style="font-size: 16px; padding-left: 20px;">
                                    <li><strong>Plan:</strong> {{ $details['plan_name'] ?? '-' }}</li>
                                ...
                                <p>The subscription is now active, and all books included under the subscription are available.</p>

                                <p style="margin-top: 30px;"><strong>{{ App_Name(); }}</strong> Team</p>
                            </div>
                        </td>
                    </tr>
