                        ...
                        <td style="padding: 30px; color: #000000;">
                            <div style="font-size: 18px; line-height: 1.7;">
                                <p style="margin-bottom: 20px;">
                                    We appreciate your interest in becoming an author on <strong>{{ App_Name(); }}</strong>.<br><br>
                                    After careful review, we regret to inform you that your author request has been <strong style="color: red;">Rejected</strong> at this time.
                                </p>

                                <p>If you believe this was a mistake or if you'd like to apply again in the future, feel free to contact our team or reapply.</p>
